...
export function updateSeatsStatus(arg0: string, arg1: string, arg2: number, arg3: string) {
    throw new Error("Function not implemented.");
}
function groupShowsByTheatreAndMovie(shows: (Document<unknown, {}, IShow, {}> & IShow & Required<{ _id: string; }> & { __v: number; })[]) {
    throw new Error("Function not implemented.");
}
